I have finally found a worthy reason to bypass the system. Look at this extension, that is actually a RAT (Remote Access Trojan) in disguise. In this journey, I will try to figure out how to bypass this.
